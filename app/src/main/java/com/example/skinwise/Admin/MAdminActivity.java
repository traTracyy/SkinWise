...
public class MAdminActivity extends AppCompatActivity {
    ...
    BottomNavigationView nav_bottom3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_bottom3 = findViewById(R.id.nav_bottom3);
        getSupportFragmentManager().beginTransaction().replace(R.id.container3, new AManage()).commit();
        nav_bottom3.setSelectedItemId(R.id.nav_ConversationList);
        nav_bottom3.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                Fragment fragment = null;
                switch (item.getItemId()) {
                    case R.id.nav_AHome:
                        fragment = new AManage();
                        break;
                    case R.id.nav_AView:
                        fragment = new AManageU();
                        break;
                    case R.id.nav_AFeed:
                        fragment = new AFeedback();
                        break;
                    case R.id.nav_Asetting:
                        fragment = new ASetting();
                        break;
                }
