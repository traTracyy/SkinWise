...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registersellertxt = findViewById(R.id.registerdermtxt);
        ...
        //lead to dermatologist register page
        registersellertxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LoginActivity.this, RegisterDermaActivity.class));
            }
        });
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds: snapshot.getChildren()){
                            ...
                            String approved = ""+ds.child("approve").getValue();
                            ...
                            switch (role) {
                                ...
                                case "Derma":
                                    if("true".equals(approved)){
                                        progressDialog.dismiss();
                                        startActivity(new Intent(LoginActivity.this, MDermaActivity.class));
                                        finish();
                                    } else {
                                        progressDialog.dismiss();
                                        Toast.makeText(LoginActivity.this, "Account approval pending.", Toast.LENGTH_LONG).show();
                                    }
                                    break;
                                case "admin":
                                    progressDialog.dismiss();
                                    startActivity(new Intent(LoginActivity.this, MAdminActivity.class));
                                    finish();
                                    break;
                            }
                        }
