...
import com.example.skinwise.User.RegisterUserActivity;
...
public class RegisterDermaActivity extends AppCompatActivity {

    private EditText namehint,phonenumberhint, emailhint,passwordhint,passwordhint2,addresshint,addresshint1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registersellertxt = findViewById(R.id.registerdermatxt);
        ...
        addresshint1 = findViewById(R.id.addresshint1);
        ...
        registersellertxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(RegisterDermaActivity.this, RegisterUserActivity.class));
            }
        });
        ...
        Rlayout2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RegisterDermaActivity.this, LoginActivity.class));
            }
        });
    ...
    private void stateDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(RegisterDermaActivity.this);
    ...
    private String name,email,phnum,password,cpassword,state1, state;
    ...
    private void inputData(){
        ...
        state1 =addresshint1.getText().toString().trim();

        if(TextUtils.isEmpty(name)){
            Toast.makeText(this,"Please Enter Your Clinic Name",Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        if(e instanceof FirebaseAuthUserCollisionException){
                            Toast.makeText(RegisterDermaActivity.this,"Email already in use, please use another email",Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(RegisterDermaActivity.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            ...
            ref.child(firebaseAuth.getUid()).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            progressDialog.dismiss();
                            Toast.makeText(RegisterDermaActivity.this, "Pending Approval", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(RegisterDermaActivity.this, LoginActivity.class));
                            finish();
                        }
                    })
